...
3. A toast notification appears at the bottom: **"Deleted [name]" — Undo**
   ...
   ![Delete confirmation toast with Undo option](../images/features/safety-trash-and-undo-01.png)
...
1. Go to **Options → Trash** tab
   ...
   ![Trash tab listing deleted shortcuts](../images/features/safety-trash-and-undo-02.png)

2. Click **Restore** on any item to bring it back to your active Search URLs list

   ![Restoring an item from Trash](../images/features/safety-trash-and-undo-03.png)

3. Click **Delete Permanently** on an item to remove it for good, or **Empty Trash** to permanently clear everything at once

   ![Empty trash / permanent delete controls](../images/features/safety-trash-and-undo-04.png)
...
2. Set the number of days (1–90) to keep deleted items before they are automatically and permanently removed
   ...
   ![Trash retention setting](../images/features/safety-trash-and-undo-05.png)
